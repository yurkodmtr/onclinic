...
add_action( 'woocommerce_after_single_product_summary', 'onclinic_single_product_row_close', 5 );
...
add_action( 'woocommerce_after_single_product_summary', 'onclinic_single_product_content_column_close', 1 );
add_filter( 'woocommerce_product_thumbnails_columns', 'onclinic_wc_product_thumbnails_columns' );

add_action( 'woocommerce_review_before_comment_text', 'onclinic_review_before_comment_text', 1 );
add_action( 'woocommerce_review_after_comment_text', 'onclinic_review_after_comment_text', 1 );
...
if ( ! function_exists( 'onclinic_review_before_comment_text' ) ) {
    function onclinic_review_before_comment_text() {
        echo '<div class="comment_author_row">';
    }
}

if ( ! function_exists( 'onclinic_review_after_comment_text' ) ) {
    function onclinic_review_after_comment_text() {
        echo '</div>';
    }
}