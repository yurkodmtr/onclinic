	...
	return apply_filters( 'onclinic-theme/customizer/options' , array(
		...
		'options'       => array(
            ...
            'is_sticky_mode' => array(
                'title' 			=> esc_html__( 'Sticky Header', 'onclinic' ),
                'section' 			=> 'header_styles',
                'default' 			=> false,
                'field' 			=> 'checkbox',
                'type' 				=> 'control',
            ...
            'header_content' => array(
                'title' 			=> esc_html__( 'Content', 'onclinic' ),
                'panel' 			=> 'header_panel',
                'type' 				=> 'section',
            ),
            'header_address_text' => array(
                'title' 			=> esc_html__( 'Address Text', 'onclinic' ),
            ...
            'header_address_text_checkbox' => array(
                'title' 			=> esc_html__( 'Show Address Text', 'onclinic' ),
                'section' 			=> 'header_content',
                'default' 			=> true,
                'field' 			=> 'checkbox',
                'type' 				=> 'control',
            ...
            'header_phone_text' => array(
                'title' 			=> esc_html__( 'Phone Text', 'onclinic' ),
                'section' 			=> 'header_content',
            ...
            'header_phone_number' => array(
                'title' 			=> esc_html__( 'Phone Number', 'onclinic' ),
                'section' 			=> 'header_content',
            ...
            'header_phone_checkbox' => array(
                'title' 			=> esc_html__( 'Show Header Phone', 'onclinic' ),
                'section' 			=> 'header_content',
                'default' 			=> true,
                'field' 			=> 'checkbox',
                'type' 				=> 'control',
            ...
            'header_button_title' => array(
                'title' 			=> esc_html__( 'Button title', 'onclinic' ),
                'section' 			=> 'header_content',
            ...
            'header_button_link' => array(
                'title' 			=> esc_html__( 'Button Link', 'onclinic' ),
                'section' 			=> 'header_content',
                'default' 			=> '#',
                'field' 			=> 'input',
                'type' 				=> 'control',
            ...
            'header_button_checkbox' => array(
                'title' 			=> esc_html__( 'Show Header Button', 'onclinic' ),
                'section' 			=> 'header_content',
                'default' 			=> true,
                'field' 			=> 'checkbox',
                'type' 				=> 'control',
